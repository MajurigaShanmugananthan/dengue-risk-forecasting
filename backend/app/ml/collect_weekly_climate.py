# E:\dengue_project\backend\collect_weekly_climate_final.py
import pandas as pd
...
for i in range(0, len(remaining_mohs), batch_size):
    ...
    for _, row in enumerate(batch):
        ...
        try:
            ...
            if data.empty:
                print(f"❌ No data found for {moh_name}")
                continue
...
print("🎉 Climate data collection completed successfully for all MOHs!")
